...
- **PR title format:** `[E06-Th01-S01-T01] <verb> <object>`
- **Branch name:** `task/E06-Th01-S01-T01-<slug>`
- **After merge:** `/task-complete E06-Th01-S01-T01 --pr "#NN"`
...
|---|---|
| **ID** | `E06-Th01-S01-T01` |
| **Title** | App shell, navigation & shared design system |
| **Description** | RN + Hermes app skeleton, navigation graph, shared design-system package with web, theming/dynamic type, cold-start budget instrumentation, OTA update channel. |
| **Owner** | claude-code |
| **Estimate** | L |
| **Depends on** | E01-Th01-S01-T01 |
| **Status** | not_started |
| **Dev tool** | inherit |
...
- After merge: run `/task-complete E06-Th01-S01-T01 --pr "#NN"` (auto-updates 04b table, Excel, status)
