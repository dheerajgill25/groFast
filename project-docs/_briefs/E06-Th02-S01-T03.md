...
- **PR title format:** `[E06-Th02-S01-T03] <verb> <object>`
- **Branch name:** `task/E06-Th02-S01-T03-<slug>`
- **After merge:** `/task-complete E06-Th02-S01-T03 --pr "#NN"`
...
|---|---|
| **ID** | `E06-Th02-S01-T03` |
| **Title** | Web cart, checkout, payment & COD |
| **Description** | Cart parity with the app (same server cart), bill/coupon UI, ETA promise, gateway checkout, COD selection per eligibility, XSS-safe rendering of user-supplied fields. |
| **Owner** | claude-code |
| **Estimate** | L |
| **Depends on** | E06-Th02-S01-T02, E02-Th04-S01-T01, E03-Th03-S01-T02, E03-Th04-S01-T01 |
| **Status** | not_started |
| **Dev tool** | inherit |
...
- After merge: run `/task-complete E06-Th02-S01-T03 --pr "#NN"` (auto-updates 04b table, Excel, status)
