...
- **PR title format:** `[E06-Th02-S01-T04] <verb> <object>`
- **Branch name:** `task/E06-Th02-S01-T04-<slug>`
- **After merge:** `/task-complete E06-Th02-S01-T04 --pr "#NN"`
...
|---|---|
| **ID** | `E06-Th02-S01-T04` |
| **Title** | Web tracking, history & accessibility pass |
| **Description** | Tracking map with WS + polling fallback, order history/reorder/invoice download, WCAG 2.1 AA audit + fixes across all web surfaces. |
| **Owner** | claude-code |
| **Estimate** | M |
| **Depends on** | E06-Th02-S01-T03, E04-Th04-S01-T04, E03-Th01-S02-T02 |
| **Status** | not_started |
| **Dev tool** | inherit |
...
- After merge: run `/task-complete E06-Th02-S01-T04 --pr "#NN"` (auto-updates 04b table, Excel, status)
