...
- **PR title format:** `[E06-Th01-S01-T03] <verb> <object>`
- **Branch name:** `task/E06-Th01-S01-T03-<slug>`
- **After merge:** `/task-complete E06-Th01-S01-T03 --pr "#NN"`
...
|---|---|
| **ID** | `E06-Th01-S01-T03` |
| **Title** | Screen batch — browse, search & PDP (SC-005, SC-006, SC-007, SC-008) |
| **Description** | Home/category browse with skeleton loads, search with typo-tolerant results + empty-state alternates, product detail, unavailable-at-store state. |
| **Owner** | claude-code |
| **Estimate** | L |
| **Depends on** | E06-Th01-S01-T02, E02-Th02-S01-T04, E02-Th03-S01-T03 |
| **Status** | not_started |
| **Dev tool** | inherit |
...
- After merge: run `/task-complete E06-Th01-S01-T03 --pr "#NN"` (auto-updates 04b table, Excel, status)
