...
- **PR title format:** `[E06-Th01-S01-T04] <verb> <object>`
- **Branch name:** `task/E06-Th01-S01-T04-<slug>`
- **After merge:** `/task-complete E06-Th01-S01-T04 --pr "#NN"`
...
|---|---|
| **ID** | `E06-Th01-S01-T04` |
| **Title** | Screen batch — cart, checkout & payment incl. COD (SC-009, SC-010, SC-011, SC-012, SC-013) |
| **Description** | Optimistic cart with cap reasons, single-store switch prompt, bill summary + coupon apply/failure reasons, ETA promise display, gateway SDK payment sheet, COD option honouring BR-5 eligibility, failure retry/switch with cart intact. |
| **Owner** | claude-code |
| **Estimate** | L |
| **Depends on** | E06-Th01-S01-T03, E02-Th04-S01-T03, E02-Th05-S01-T02, E03-Th03-S01-T02, E03-Th04-S01-T01 |
| **Status** | not_started |
| **Dev tool** | inherit |
...
- After merge: run `/task-complete E06-Th01-S01-T04 --pr "#NN"` (auto-updates 04b table, Excel, status)
