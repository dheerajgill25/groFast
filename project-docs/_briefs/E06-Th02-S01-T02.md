...
- **PR title format:** `[E06-Th02-S01-T02] <verb> <object>`
- **Branch name:** `task/E06-Th02-S01-T02-<slug>`
- **After merge:** `/task-complete E06-Th02-S01-T02 --pr "#NN"`
...
|---|---|
| **ID** | `E06-Th02-S01-T02` |
| **Title** | Web auth, location & serviceability |
| **Description** | OTP login, session/refresh in httpOnly cookies, location detection + manual address, not-serviceable + notify-me, address book. |
| **Owner** | claude-code |
| **Estimate** | M |
| **Depends on** | E06-Th02-S01-T01, E01-Th03-S01-T03, E02-Th01-S01-T04 |
| **Status** | not_started |
| **Dev tool** | inherit |
...
- After merge: run `/task-complete E06-Th02-S01-T02 --pr "#NN"` (auto-updates 04b table, Excel, status)
