...
- **PR title format:** `[E06-Th01-S01-T02] <verb> <object>`
- **Branch name:** `task/E06-Th01-S01-T02-<slug>`
- **After merge:** `/task-complete E06-Th01-S01-T02 --pr "#NN"`
...
|---|---|
| **ID** | `E06-Th01-S01-T02` |
| **Title** | Screen batch — auth & address (SC-001, SC-002, SC-003, SC-004, SC-020) |
| **Description** | OTP request/verify screens, session/refresh handling, GPS permission + auto-detect, manual-entry fallback, address book CRUD, not-serviceable + notify-me state. |
| **Owner** | claude-code |
| **Estimate** | L |
| **Depends on** | E06-Th01-S01-T01, E01-Th03-S01-T03, E02-Th01-S01-T04 |
| **Status** | not_started |
| **Dev tool** | inherit |
...
- After merge: run `/task-complete E06-Th01-S01-T02 --pr "#NN"` (auto-updates 04b table, Excel, status)
